...
use crate::{
	analysis::{
		self, imports::Imports, namespaces, override_string_type::override_string_type_return, rust_type::RustType,
	},
	config,
	env::Env,
...
pub fn analyze(
	...
	let bool_return_is_error = configured_functions.iter().find_map(|f| f.ret.bool_return_is_error.as_ref());
